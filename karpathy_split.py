...
seed(21)  # Make it reproducible

num_val = 5000
num_test = 5000

val = json.load(open('./data/coco/annotations/captions_train2014.json', 'r'))
train = json.load(open('./data/coco/annotations/captions_val2014.json', 'r'))
...
for subset in split:
    ...
    json.dump(json_data[subset], open('./data/coco/karpathy_split_' + subset + '.json', 'w'))
